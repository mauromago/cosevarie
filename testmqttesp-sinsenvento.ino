...
const char* mqtt_topic = "sinsenven-test";

char sensState[4];
//int sensState;

IPAddress subnet(255, 255, 255, 0); // set subnet mask to match your network
IPAddress ip(192, 168, 1, 224); // controllare che non sia doppio
...
void setup() {
  ...
  randomSeed(analogRead(65744987));
  //setup WiFi
  setup_wifi();
